-- PROD-BACKUP (red_* funktioner + policies) genereret før 2C-2a-deploy
-- 13 red_*-funktioner, 43 policies
...
-- === POLICIES (metadata) ===
-- public.assertion  anon_read  cmd=SELECT
-- public.assertion  auth_read  cmd=SELECT
-- public.assertion  redaktion_read  cmd=SELECT
-- public.citation  anon_read  cmd=SELECT
-- public.citation  auth_read  cmd=SELECT
-- public.citation  redaktion_read  cmd=SELECT
-- public.coat_of_arms  anon_read  cmd=SELECT
-- public.conclusion  anon_read  cmd=SELECT
-- public.conclusion  auth_read  cmd=SELECT
-- public.conclusion  redaktion_read  cmd=SELECT
-- public.estate  anon_read  cmd=SELECT
-- public.fact  anon_read  cmd=SELECT
-- public.fact  auth_read  cmd=SELECT
-- public.fact  redaktion_read  cmd=SELECT
-- public.family  anon_read  cmd=SELECT
-- public.family_member  anon_read  cmd=SELECT
-- public.family_member  auth_read  cmd=SELECT
-- public.family_member  redaktion_read  cmd=SELECT
-- public.historical_event  anon_read  cmd=SELECT
-- public.lineage  anon_read  cmd=SELECT
-- public.narrative  anon_read  cmd=SELECT
-- public.narrative  auth_read  cmd=SELECT
-- public.narrative  redaktion_read  cmd=SELECT
-- public.note  anon_read  cmd=SELECT
-- public.note  auth_read  cmd=SELECT
-- public.note  redaktion_read  cmd=SELECT
-- public.organisation  anon_read  cmd=SELECT
-- public.person  anon_read  cmd=SELECT
-- public.person  auth_read  cmd=SELECT
-- public.person  redaktion_read  cmd=SELECT
-- public.person_external_id  anon_read  cmd=SELECT
-- public.person_external_id  auth_read  cmd=SELECT
-- public.person_external_id  redaktion_read  cmd=SELECT
-- public.place  anon_read  cmd=SELECT
-- public.profiles  self_read  cmd=SELECT
-- public.relation  anon_read  cmd=SELECT
-- public.relation  auth_read  cmd=SELECT
-- public.relation  redaktion_read  cmd=SELECT
-- public.repository  anon_read  cmd=SELECT
-- public.source  anon_read  cmd=SELECT
-- public.suggestion  own_read  cmd=SELECT
-- public.suggestion  redaktion_read_all  cmd=SELECT
-- public.vocab  anon_read  cmd=SELECT
