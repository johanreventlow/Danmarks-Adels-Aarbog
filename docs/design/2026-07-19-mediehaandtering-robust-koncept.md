...
| **3 — Hygiejne** | sha256 ved upload, sha-stier, dedup-UX, janitor-script | M8, M9 (oprydning) | klient-hash, `import/janitor`-R-script, verify-asserts. **Spec skrevet:** [`../superpowers/specs/2026-07-20-mediehaandtering-fase3-hygiejne-design.md`](../superpowers/specs/2026-07-20-mediehaandtering-fase3-hygiejne-design.md) |
