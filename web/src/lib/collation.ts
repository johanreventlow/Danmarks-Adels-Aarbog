// Dansk collation — delt 1:1 med mobile/src/lib/collation.ts (samme adfærd på tværs af apps).
// EKSPLICIT orden i stedet for String.localeCompare(a,b,'da'): vi mapper hvert tegn til en rang
// hvor Æ Ø Å ligger EFTER Z, så alfabet-hop (§9.1) og sticky-grupper sorterer ens uanset motor.
