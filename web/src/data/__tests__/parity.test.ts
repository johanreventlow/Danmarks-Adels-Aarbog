...
// Modul-niveau paritet (review 27 §2 / T2) dækkede tidligere HELE filer for et sæt "spejlede"
// moduler — ren logik identisk kopieret ind i både web/src/data og mobile/src/data, fordi der
// endnu ikke fandtes en delt npm-pakke. Alle fire (collapseSameAs, relationship,
// sammeSomPreflight, buildModel) er nu flyttet til @daa/core (spike-task 5) — kun ÉN kopi
// findes, så filniveau-parity-tjekket er strukturelt umuligt at fejle og er derfor fjernet
// (en tom MIRRORED_MODULES-løkke ville ikke assertere noget).
