...
export function MaterialeSektion({ objektType, objektId, onMediaChange }: {
  ...
  return <>
    <MediaGallery media={media} mediaUris={mediaUris} mediaThumbUris={mediaThumbUris}
      ...
      onSlet={(m) => change({ art: 'fjernMedia', subjektType: objektType, subjektId: objektId, mediaId: m.id })}
    ...
    {valgt ? <MediaDetaljeSheet media={valgt} uri={mediaUris[valgt.id]} onClose={() => setValgt(null)}
