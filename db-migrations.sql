...
-- is_identity-guarden. Idempotent: kan køres igen uden effekt.
-- =============================================================
DO $$
DECLARE
  t TEXT;
...
BEGIN
  FOREACH t IN ARRAY tabeller LOOP
    ...
    END IF;
    -- Sekvens-sync er bevidst UDEN for identity-guarden: kør altid, så en
    -- gen-kørsel efter mellemliggende eksplicitte id-inserts også re-syncer.
    EXECUTE format(
